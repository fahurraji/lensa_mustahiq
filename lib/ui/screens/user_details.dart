...
class MustahiqUserDetails extends StatefulWidget {
  final Modelmustahiq modelmustahiq;
  MustahiqUserDetails(this.modelmustahiq);

  @override
  _MustahiqUserDetailsState createState() => _MustahiqUserDetailsState(modelmustahiq);
}


class _MustahiqUserDetailsState extends State<MustahiqUserDetails> {
  final Modelmustahiq modelmustahiq;

  _MustahiqUserDetailsState(this.modelmustahiq);
  @override
  void initState() {
    super.initState();
  }
