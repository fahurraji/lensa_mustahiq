...
class EditMustahiq extends StatefulWidget {
  final Modelmustahiq model;
  final VoidCallback reload;

  EditMustahiq(this.model, this.reload);
  

  // const EditMustahiq({Key key, this.model}) : super(key: key);

  
  @override
  _EditMustahiqState createState() => _EditMustahiqState();
}

class _EditMustahiqState extends State<EditMustahiq> {
...
createdBy, updatedAt, updatedBy, isDeleted;
  ...
  Future editData(File imageFile) async{
    ...
    var uri = Uri.parse(BaseUrl().editMustahiq);
