...
class MustahiqBantuan extends StatefulWidget {
  final Modelmustahiq modelmustahiq;
  MustahiqBantuan(this.modelmustahiq);

  @override
  _MustahiqBantuanState createState() => _MustahiqBantuanState(modelmustahiq);
}



class _MustahiqBantuanState extends State<MustahiqBantuan> {
  final Modelmustahiq modelmustahiq;

  _MustahiqBantuanState(this.modelmustahiq);
  ...
  void approveData(){
    // var url = "http://192.168.43.197/lensa-mustahiq/beckend/mustahiq_bantuan.php";
    var url = BaseUrl().approveBantuan;
    http.post(url, body: {
      'id_mustahiq': widget.modelmustahiq.id,
    });
  }
  ...
  void approveConfirm(){
    AlertDialog alertDialog = new AlertDialog(
      content: new Text("Anda Yakin Akan Menyerahkan Bantuan Ini"),
      actions: <Widget>[
        new RaisedButton(
          child: Text("OK"),
          color: Colors.red,
                  ...
                  Column(
                    ...
                    children: <Widget>[ 
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                          widget.modelmustahiq.tglSurvey
                          ),
                      )
                    ],
                  ),
